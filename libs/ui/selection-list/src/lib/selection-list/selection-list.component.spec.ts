...
import { TsSelectionListTriggerDirective } from '../trigger/selection-list-trigger.directive';
import {
  TsSelectionListComponent,
  TsSelectionListModule,
} from '../ui-selection-list.module';
...
describe(`TsSelectionListComponent`, function() {
  ...
  describe(`clearPreviousSelectedOption`, () => {
    let fixture: ComponentFixture<Seeded>;
    ...
    beforeEach(() => {
      ...
      fixture.detectChanges();
      const instance = getSelectionListInstance(fixture);
      // FIXME: Not sure why this TS flag is needed after the monorepo move. Seems to be due to one item coming from dist and the other
      // from src.
      // @ts-ignore
